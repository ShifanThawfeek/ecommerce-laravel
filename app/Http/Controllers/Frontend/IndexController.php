...
class IndexController extends Controller
{
    public function index()
    {
        ...
        $skip_category_0 = Category::skip(0)->first();  //selects the first id
    ...
    public function UserPasswordUpdate(Request $request)
    {
        $validateData = $request->validate([
            ...
            'password' => 'required|confirmed', //By default, Laravel 'confirmed' validator adds the error message to the original field and not to the field which usually contains the confirmed value
        ]);
    ...
    public function ProductDetails($id,$slug)
    {
        ...
        'product_color_en','product_color_hin','product_size_en','product_size_hin',
        'relatedProduct'));
    }
    ...
    {
        $products = Product::where('status',1)->where('susbsubcategory_id',$subsubcat_id)->orderBy('id','DESC')->paginate(6);
        $categories = Category::orderBy('category_name_en','ASC')->get();
