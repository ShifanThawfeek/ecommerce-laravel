                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="subsubcategory_id" class="form-control" required="">
                                                        ...
                                                        <option value="{{ $subsub->id }}" {{ $subsub->id == $products->susbsubcategory_id ? 'selected' : ''}}> {{ $subsub->subsubcategory_name_en }}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="test" name="product_name_hin" class="form-control" required="" value="{{ $products->product_name_hin }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Short Description English<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <textarea name="short_descp_hin" id="textarea" class="form-control" required placeholder="Textarea text">{!! $products->short_descp_hin !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
